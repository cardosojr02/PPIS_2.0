            ...
            <div id="appMoviles">
                <div class="card mb-4">
                    ...
                    <!-- BARRA DE BUSQUEDA  -->
                        ...
                        <a href='?opcion=1'><button class="btn btn-primary" title="Nuevo"><i class="fas fa-plus-circle fa-2x"></i></button></a>
                        </div>
                    </div>                
                        <div class="table-responsive">
                            <table id="usuarios" class="table table-bordered" width="100%" cellspacing="0">
                                <thead>
                                ...
                                <?php foreach($data as $row){
                                    ...
                                    <td><div class='btn-group' role='group'>
                                              <a href='?opcion=2&id=".$row['id']."'>   <button class='btn btn-secondary' title='Editar' >
                                                    <i class='fas fa-pencil-alt'></i>
                                                </button></a>
                                                <a href='?opcion=3&id=".$row['id']."'> <button class='btn btn-danger' title='Eliminar' >
