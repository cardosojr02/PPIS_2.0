...
if (isset($_POST['btnRegistrar'])) {
    ...
    $insert_actividad = "INSERT INTO actividades (nombre, descripcion, docentes_responsables, presupuesto_proyectado, fecha_inicio, fecha_fin, progreso, id_subproceso_nivel2, fecha_sys) 
                      VALUES (:nombre, :descripcion, :docentes_responsables, :presupuesto_proyectado, :fecha_inicio, :fecha_fin, :progreso, :subprocesoNivel2, NOW())";
